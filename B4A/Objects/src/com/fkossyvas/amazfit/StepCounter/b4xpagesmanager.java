...
__c.LogImpl("96684675",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("96553621","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("96946820","Only top page can be closed",0);
...
__c.LogImpl("96946823","First page cannot be closed",0);
...
__c.LogImpl("97602179","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 399;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("97602180","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("96488091","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
