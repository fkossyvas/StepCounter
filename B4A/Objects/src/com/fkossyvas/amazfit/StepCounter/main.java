...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.fkossyvas.amazfit.StepCounter", "com.fkossyvas.amazfit.StepCounter.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.fkossyvas.amazfit.StepCounter", "com.fkossyvas.amazfit.StepCounter.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.fkossyvas.amazfit.StepCounter.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
...
com.fkossyvas.amazfit.StepCounter.b4xpagesmanager _pm = null;
 //BA.debugLineNum = 25;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 26;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new com.fkossyvas.amazfit.StepCounter.b4xpagesmanager();
...
if (true) return mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
...
mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
...
mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
...
mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
...
mostCurrent._b4xpages._delegate /*com.fkossyvas.amazfit.StepCounter.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
